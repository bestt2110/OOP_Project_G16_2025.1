...
public class UI extends Application {
    ...
    // ==============================
    // 4. LINE CHART: Positive/Negative theo thời gian
    // ==============================
    ...
    // ==============================
    // 5. BAR CHART: Positive/Negative theo loại cứu trợ
    // ==============================
    private BarChart<String, Number> createBarChart() {
        ...
        for (Map.Entry<String, ReliefSentimentCount> entry : storedResult.entrySet()) {
            ...
            posSeries.getData().add(new XYChart.Data<>(category, count.getPositive()));
            negSeries.getData().add(new XYChart.Data<>(category, count.getNegative()));
        }
